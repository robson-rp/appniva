...
class Profile extends Model
{
    ...
    public function userCostCenterBudgets(): HasMany
    {
...
echo "Mapeamento de relacionamentos criado.\n";
echo "Total de modelos com relacionamentos: " . count($relationshipsMap) . "\n";
?>
